...
The Amber force field implementation in OSPREY3 includes code copyright 2001-2018 by the Bruce Donald Lab at Duke University (as noted in `ForcefieldFileParser.java` header, signed March 1, 2018). The Amber parameter classes were added to OSPREY3 in a large commit ([adb27be](https://github.com/donaldlab/OSPREY3/commit/adb27be298bd57b8d159a41b90884bea9803e3bc)) in 2021, implementing the Amber force field system.

**Note:** The copyright header indicates the force field parser code was developed as part of OSPREY 3.0 by the Donald Lab at Duke University, showing the close integration of Amber force fields with OSPREY's energy calculation system.
...
- **Latest Run**: BUILD SUCCESSFUL in 3m 23s (JDK 17)
