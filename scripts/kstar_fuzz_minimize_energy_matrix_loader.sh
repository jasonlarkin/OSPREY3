...
# Minimize a crashing libFuzzer artifact for the EnergyMatrixLoader target.
#
# Usage:
#   ./scripts/kstar_fuzz_minimize_energy_matrix_loader.sh <artifact_file> <out_file> [fuzz_build_dir]
#
# Notes:
