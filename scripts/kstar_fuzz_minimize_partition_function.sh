...
# Minimize a crashing libFuzzer artifact for the PartitionFunction target.
#
# Usage:
#   ./scripts/kstar_fuzz_minimize_partition_function.sh <artifact_file> <out_file> [fuzz_build_dir]
#
# Notes:
