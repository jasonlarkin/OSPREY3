#!/usr/bin/env python3
"""
Extract HOOMD-blue ForceCompute/Potential interfaces from local headers and update interface inventory.
...
HOOMD_HEADERS = {
    'ForceCompute': 'interfaces/hoomd-blue/hoomd/ForceCompute.h',
    'PotentialPair': 'interfaces/hoomd-blue/hoomd/md/PotentialPair.h',
    'SystemDefinition': 'interfaces/hoomd-blue/hoomd/SystemDefinition.h',
    'Integrator': 'interfaces/hoomd-blue/hoomd/Integrator.h',
    'Compute': 'interfaces/hoomd-blue/hoomd/Compute.h',
}

TARGET_DOSSIER = repo_root / 'interfaces/hoomd-blue/interface_inventory.md'
...
def extract_all_interfaces() -> Dict[str, Dict]:
    ...
    for interface_name, rel_path in HOOMD_HEADERS.items():
...
def format_extracted_api(extracted: Dict[str, Dict]) -> str:
    ...
    lines.append("<!-- AUTO:HOOMD_API_END -->")
